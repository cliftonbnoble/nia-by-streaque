/* Shared chrome for the Nia page — the brand glyph and a couple of small marks,
   so every section speaks the same visual language as the rest of the site.
   No hooks, so server and client components can both import it. */

export const NiaGlyph = ({ s = 22, gid = "ng" }) => (
...
/* circular white chip holding the glyph — the in-app/notification mark */
export const NiaMark = ({ s = 30, gid = "nm" }) => (
  <span className="np-niamark" style={{ width: s, height: s }}><NiaGlyph s={Math.round(s * 0.66)} gid={gid}/></span>
);
