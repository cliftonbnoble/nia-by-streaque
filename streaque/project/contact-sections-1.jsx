      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
        <div>
          ...
          <div style={{ marginTop: 28, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            ...
            <a href="#founders" className="mf-btn mf-btn-secondary" style={{ textDecoration: 'none' }}>
              Talk to founders
            </a>
          </div>
          <div style={{ marginTop: 32, display: 'flex', gap: 24, flexWrap: 'wrap', fontSize: 13, color: 'var(--ink-3)' }}>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
              <Dot color="var(--success, #10b981)"/> Replies within 1 business day
            </span>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ position: 'relative', minHeight: 520 }}>
          ...
          <div style={{
            ...
            <div style={{ width: 40, height: 40, borderRadius: 10, background: 'var(--primary-50)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src="assets/call-nia-icon.png" alt="" style={{ width: 22, height: 22, opacity: 0.9 }}/>
            </div>
            <div>
          ...
          {/* floating card bottom-right: response */}
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 11, color: 'var(--ink-3)', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
              <Dot color="#10b981"/> Replied · 16:08
            </div>
  ...
  const paths = [
    {
      ...
      title: 'Start a pilot',
      body: 'Bring Nia to your campus. We\'ll scope a pilot tailored to your LMS, SIS, and student-success workflows.',
    ...
    },
    {
      ...
      title: 'Talk directly',
      body: 'Skip the form — book time with Luke or Clifton. Best for higher-ed leaders, peer founders, or partnership conversations.',
      cta: 'Book with founders',
      href: '#founders',
      icon: 'founders',
    ...
    },
    {
      ...
      body: 'Request our latest deck, ARR/runway snapshot, and pilot-pipeline overview. We send a fresh brief every Friday.',
      cta: 'Request brief',
      href: 'mailto:info@streaque.com?subject=Investor%20brief%20request',
      icon: 'investor',
      accent: '#7c3aed',
    },
  ];
...
window.ContactHero = Hero;
window.ContactPaths = Paths;
