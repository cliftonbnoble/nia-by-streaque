/* How Nia Works — uses the mid-fi B+ design system (midfi.css)
   Reuses TrustBar / NavBar / Footer chrome from the homepage.
   Adapts the live page sections into product-grade mocks. */
  ...
  <div className="mf-nav">
    <div className="mf-nav-inner">
      ...
      <div className="mf-nav-links">
        ...
        <a className="active">How Nia Works</a>
        <a href="Contact.html">Contact</a>
      </div>
      <a href="Contact.html#form" className="mf-btn mf-btn-primary mf-btn-sm" style={{ textDecoration: 'none' }}>Book a demo <ArrowR s={12}/></a>
    </div>
  </div>
);
...
// mini mocks for the three hero cards
const SentimentMock = () => (
...
// ── BRIDGE: The Power is in the Connection ──────────
const Connection = () => (
...
const STUDENT_FEATURES = [
  {
    n: '01',
    t: 'Intelligent Chat Assistant',
    b: 'Personalized to your schedule, courses, and goals — grounded in the real data your institution already trusts.',
    bullets: [
      'Access to all university resources — handbooks, policies, course catalogs',
      'Answers drawn from your LMS, SIS, and CRM',
      'Personalized to your schedule, courses, and goals',
    ],
    Mock: ChatMock,
  },
  {
    n: '02',
    t: 'Proactive Coaching & Nudges',
    b: 'Quiet, well-timed reminders that meet you where you are — not another inbox to check.',
    bullets: [
      '24/7 AI agents monitoring your academic progress',
      'Smart reminders for assignments, deadlines, events',
      'Job fair alerts and career opportunities',
  ...
  {
    n: '03',
    t: 'Learns Your Preferences',
    b: 'Builds a private, FERPA-scoped model of how you study best — and adapts everything to fit.',
    bullets: [
      'Tracks when and how you study best',
      'Adapts communication style to your needs',
      'Builds a profile to deliver smarter support',
  ...
  {
    n: '04',
    t: 'Comprehensive Integration',
    b: 'One brain across every campus system — not a stitched-together set of point tools.',
    bullets: [
      'Connected to your LMS for assignment tracking',
      'SIS integration for academic records',
      'CRM-aware for advising context',
      'All your university resources in one place',
    ],
...
const ForStudents = () => (
  <section className="mf-section">
    <div className="mf-container">
      ...
      <PullQuote
        quote="Not just answers. A partner in your success."
        sub="Real-time data flows from student interactions to staff dashboards →"
      />
    </div>
  </section>
);
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center', padding: '32px 0', borderTop: '1px solid var(--line)' }}>
      <div style={{ order: flip ? 2 : 1 }}>
        ...
        <p style={{ fontSize: 15, marginTop: 10, color: 'var(--ink-2)' }}>{f.b}</p>
...
const STAFF_FEATURES = [
  {
    n: '01', t: 'Early-warning system',
    bullets: [
      'Real-time sentiment analysis',
      'Automated alerts for engagement drops',
      'AI agents scanning for warning signs',
      'Track assignment trends, attendance, participation',
    ],
    Mock: WarningMock,
  },
  {
    n: '02', t: 'Comprehensive dashboards',
    bullets: [
      'Sentiment trends over time',
      'Engagement metrics and patterns',
      'LMS performance data integration',
      'Identify at-risk students instantly',
    ],
    Mock: DashboardMock,
  },
  {
    n: '03', t: 'AI-powered insights',
    bullets: [
      'Same powerful AI as the student tool',
      'Access to documents, calendars, policies',
      'Student LMS, SIS, and CRM data visibility',
      'Context-aware recommendations',
    ],
    Mock: InsightsMock,
  },
  {
    n: '04', t: 'Intervention & recognition',
    bullets: [
      'Reach out to struggling students proactively',
      'Identify high performers for recognition',
      'Track intervention effectiveness',
      'Close the loop on student support',
    ],
    Mock: InterventionMock,
  },
  {
    n: '05', t: 'Predictive analysis',
    bullets: [
      'Know when students are overwhelmed — before they do',
...
const ForStaff = () => (
  <section className="mf-section alt">
    <div className="mf-container">
      ...
      <PullQuote
        quote="From reactive to proactive. From guesswork to certainty."
        sub="The complete picture →"
      />
    </div>
  </section>
);
...
// ── OUTCOME / CTA ──────────────────────────────────
const Outcome = () => (
  <section style={{ background: 'var(--ink)', color: 'white', padding: '96px 0', position: 'relative', overflow: 'hidden' }} id="contact">
    ...
    <div className="mf-container" style={{ position: 'relative', textAlign: 'center', maxWidth: 820 }}>
      ...
      <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 24px', borderRadius: 'var(--radius)', background: 'white', color: 'var(--ink)', fontWeight: 500, fontSize: 15 }}>Schedule a demo <ArrowR/></span>
        <a href="Streaque Mid-fi.html" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 24px', borderRadius: 'var(--radius)', background: 'transparent', color: 'white', fontWeight: 500, fontSize: 15, border: '1px solid rgba(255,255,255,0.3)' }}>Back to home</a>
      </div>
    </div>
  </section>
);
...
const Footer = () => (
  <footer style={{ background: '#05071a', color: 'rgba(255,255,255,0.7)', padding: '64px 0 32px' }}>
    <div className="mf-container">
      <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr 1fr 1.2fr', gap: 40, marginBottom: 48 }}>
        <div>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 10, fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 22, color: 'white', letterSpacing: '-0.01em' }}>Streaque</span>
...
window.HowNiaWorks = HowNiaWorks;
